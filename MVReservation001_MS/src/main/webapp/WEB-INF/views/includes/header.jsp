...
<header id="header" class="header fixed-top d-flex align-items-center">
	...
	<div class="d-flex align-items-center justify-content-between">
		<a href="${pageContext.request.contextPath }/"
			...
			alt=""> <span class="d-none d-lg-block">MV_RESERVATION</span>
		...
		<ul class="d-flex align-items-center">
			...
			<!-- End Messages Icon -->
				...
				<ul
					...
					<img src="${pageContext.request.contextPath }/resources/assets/img/messages-1.jpg"
					...
					<li class="message-item"><a href="#"> <img
							src="${pageContext.request.contextPath }/resources/assets/img/messages-2.jpg"
							alt="" class="rounded-circle">
							<div>
								<h4>Anna Nelson</h4>
								<p>Velit asperiores et ducimus soluta repudiandae labore
					...
					<li class="message-item"><a href="#"> <img
							src="${pageContext.request.contextPath }/resources/assets/img/messages-3.jpg"
							alt="" class="rounded-circle">
							<div>
								<h4>David Muldon</h4>
								<p>Velit asperiores et ducimus soluta repudiandae labore
			...
			<li class="nav-item dropdown pe-3">
				<c:choose>
					<c:when test="${sessionScope.loginId == null }">
						...
						<a class="nav-link nav-profile d-flex align-items-center pe-0"
							...
							class="d-none d-md-block dropdown-toggle ps-2">비회원</span>
						</a>
						...
						<c:choose>
							<c:when test="${sessionScope.loginProfile == null}">
								...
								<a class="nav-link nav-profile d-flex align-items-center pe-0"
									...
									<img src="${pageContext.request.contextPath }/resources/assets/img/20150715203013-Z7C26.png"
									alt="Profile" class="rounded-circle"> <span
									class="d-none d-md-block dropdown-toggle ps-2">${sessionScope.loginId}</span>
								</a>
							</c:when>
							<c:otherwise>
								<%-- 프로필이 등록되어 있을 경우 --%>
				...
				<ul
					...
					<li class="dropdown-header">
						<h6>로그인 아이디 : ${sessionScope.loginId}</h6> <!-- <span>Web Designer</span> -->
					</li>
					<li>
						<hr class="dropdown-divider">
					</li>
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="${pageContext.request.contextPath }/reservationInfo"> <i
							class="bi bi-person"></i> <span>내 예매 정보</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
					</li>
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="${pageContext.request.contextPath }/memberLogout"> <i
							class="bi bi-gear"></i> <span>로그아웃</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
					</li>
