...
<title>TheaterListPage - 극장 목록페이지</title>
				...
				<div class="row" style="min-width: 400px;">
					...
					<c:forEach items="${thList }" var="th" >
						<div class="col-3">
							<div class="card">
								<div class="card-body">
									<h5 class="card-title py-2" style=""></h5>
									<a href="${pageContext.request.contextPath }/TheaterInfoPage?thcode=${th.thcode }">
									</a>
									<a href="${pageContext.request.contextPath }/TheaterInfoPage?thcode=${th.thcode }" 
									class="listTitle mt-2 mb-0"
									style="color: #012970; font-weight: 700;"
										title="${th.thname }">${th.thname }</a>
								</div>
							</div>
						</div>
					</c:forEach>
