...
<body>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			...
			<!-- MovieList.jsp에서 예매하기 버튼 누르면 selectmovie 이름으로 파라미터가 넘어가기 때문에 여기서 확인가능 -->
						...
						<div class="card-body">
							...
							<div class="list-group reserveArea" id="mvListArea"  >
								...
								<button type="button" class="list-group-item list-group-item-action" 
								        id="${movie.mvcode }" onclick="selectMovie(this, '${movie.mvcode }', '${movie.mvpos }' )"><span class="listTitle font-bold" title="${movie.mvtitle }">${movie.mvtitle }</span></button>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body p-3">
							<div class="row" >
								<div class="col-4">
									<img id="CheckMvPoster"  style="height: 150px;" src="">
									<h4 class="card-title" id="CheckMvTitle"></h4>
								</div>
								...
								<div class="col-2" style="text-align: center;">
									<button class="btn btn-danger font-bold mb-1 w-100 h-100" 
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			if(selMv.length > 0) {
			$("#"+selMv).focus();
			$("#"+selMv).click(); // id값이 "dd"인 것을 '클릭' 하는 기능
			}
		});
